  ...
  return (
    <form action="#">
      ...
      <div className="relative mb-4">
        ...
        <input onChange={handleSetCode} inputMode="numeric" pattern="[0-9]*" autoComplete="one-time-code" type="number" name="code" max="9999" value={code} className="border-b rounded-none tracking-[30px] py-3 px-4 md:py-4 md:px-6 w-full bg-white text-center text-xs xs:text-sm lg:text-base" />
      </div>
